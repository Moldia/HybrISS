...
% Lif input files should be named like this: "Base_1.lif", "Base_2.lif"
...
%IN THIS CASE ONLY MIPPINGALIGN IS NEEEDED, SINCE WE ONLY RUN 1 CYCLE
...
p.out_folder='O:\dRNA project\CYCLE1_2'; %Folder where output will be 
p.input_folder='O:\dRNA project\CYCLE1_2'; %Folder where your CZI files are located
p.rawfiles={
   '200414 drna roi 20x_MIPPED_sample3_tr1.lif'
   '200414 drna roi 20x_MIPPED_sample3_tr2.lif'
   '200414 drna roi 20x_MIPPED_sample3_tr3.lif'
   '200414 drna roi 20x_MIPPED_sample3_tr4.lif'  
    };
% '200414 drna roi 20x_MIPPED_sample1_tr1.lif'
%     '200414 drna roi 20x_MIPPED_sample1_tr2.lif'
%     '200414 drna roi 20x_MIPPED_sample1_tr3.lif'
%     '200414 drna roi 20x_MIPPED_sample1_tr4.lif'
%  '200414 drna roi 20x_MIPPED_sample2_tr1.lif'
%    '200414 drna roi 20x_MIPPED_sample2_tr2.lif'
%    '200414 drna roi 20x_MIPPED_sample2_tr3.lif'
%    '200414 drna roi 20x_MIPPED_sample2_tr4.lif'     
...
p.tile_stitch_channel = 5; %Cy3   % for registration between tiles
p.General_Alignment_ACGT_column_number = [0,0,4,5,2,3]; %Add columns of A ,C ,G and T in this order
...
p.quality_threshold = 0.8; % Modify the minimum quality
...
t.folder_image = [out_fold,'\Align'];
    ...
    t.channel_order = {'Nuclei', 'G', 'A', 'C', 'T'};
