...
run_Segment_YN = 1; % 1 means doing blob Identification ,0 means not to run
run_DecodingPlotting_YN = 0;
Cross_talk_YN =0; %Possibility of creating a Cross-talk plot for all the channels
...
if run_Segment_YN;
    CellSegmentationInMatlab(si.folder,si.PREFIX,si.INTERFIX,si.SUFIX,si.TYPE,ntiles,si.outputdirect,nbases,pixel_size);
end
