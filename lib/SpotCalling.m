...
function SpotCalling(folder,PREFIX,INTERFIX,SUFIX,TYPE,tiles,outputdirect,ncyc,num_pixels,num_min)
...
parfor tile = tile1:tile2 %1:tiles
...
disp(size(fres1));
freqs=fres1(:,2);
fres1=fres1(freqs>num_pixels & freqs<num_min,:);
%fres1=fres1(freqs<num_min,:);
disp(size(fres1));
